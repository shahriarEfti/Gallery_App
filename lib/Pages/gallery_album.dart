...
class GalleryAlbum extends StatelessWidget {
  late int index;
  late List<Map<String, String>> cards;

  GalleryAlbum({super.key, required this.index}) : cards = ContainerData.cards;
            ...
            Row(
              ...
              children: [
                bottomContainer(
                    ...
                    containerLabel: "Dawn",
                    containerImage:
                    "https://images.pexels.com/photos/1102909/pexels-photo-1102909.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"),
                bottomContainer(
                    orientation: orientation,
                    context: context,
                    containerLabel: "Leaves",
                    containerImage:
                    "https://images.pexels.com/photos/122429/leaf-nature-green-spring-122429.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"),
              ],
            )
          ],
        ));
